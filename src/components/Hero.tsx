...
const Hero = () => {
  return <section id="home" className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 opacity-30">
        ...
        <div className="absolute bottom-32 right-20 w-96 h-96 bg-secondary/20 rounded-full blur-3xl animate-float" style={{
        animationDelay: '2s'
      }}></div>
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-accent/20 rounded-full blur-3xl animate-float" style={{
        animationDelay: '4s'
      }}></div>
      </div>
      ...
      <div className="container mx-auto px-4 py-20 relative">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-wrap gap-4 pt-4 animate-slide-up" style={{
            animationDelay: '0.4s'
          }}>
              <Button size="lg" className="relative group overflow-hidden bg-gradient-to-r from-primary to-secondary hover:shadow-glow transition-all duration-300 hover:scale-105" onClick={() => document.querySelector("#contact")?.scrollIntoView({
              behavior: "smooth"
            })}>
          ...
          animationDelay: '0.2s'
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -right-8 w-64 h-64 bg-gradient-to-br from-secondary/20 to-transparent rounded-3xl -rotate-12 -z-10 animate-float" style={{
              animationDelay: '1s'
            }}></div>
                ...
                <div className="relative overflow-hidden rounded-full bg-card">
                  <div className="aspect-square max-w-[240px] mx-auto bg-gradient-to-br from-primary to-secondary p-1.5 rounded-full">
                    <div className="w-full h-full bg-card rounded-full overflow-hidden">
                      <img src={profilePicture} alt="Prachi Gaikwad - Software Engineer" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500" />
                    </div>
                  </div>
              ...
              <div className="absolute -top-6 -right-6 w-24 h-24 bg-gradient-to-br from-accent to-accent/50 rounded-2xl rotate-45 animate-float shadow-glow backdrop-blur-sm" style={{
              animationDelay: '0.5s'
            }}></div>
              <div className="absolute -bottom-8 -left-8 w-20 h-20 bg-gradient-to-br from-primary to-primary/50 rounded-full animate-float shadow-glow backdrop-blur-sm" style={{
              animationDelay: '1.5s'
            }}></div>
              <div className="absolute top-1/4 -right-4 w-16 h-16 bg-gradient-to-br from-secondary to-secondary/50 rounded-xl rotate-12 animate-float shadow-glow backdrop-blur-sm" style={{
              animationDelay: '2.5s'
            }}></div>
            </div>
          </div>
